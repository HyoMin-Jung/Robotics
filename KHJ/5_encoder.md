...
증분형 광학식 엔코더를 예로 들면, 모터 샤프트에 부착된 디스크에는 일정한 간격으로 슬릿(Slit) 또는 패턴이 새겨져 있습니다. 발광부에서 나온 빛이 이 디스크를 통과하거나 반사될 때, 슬릿/패턴의 유무에 따라 빛이 차단되거나 통과하게 됩니다. 수광부는 이 빛의 변화를 감지하여 구형파(Square Wave) 형태의 전기 펄스 신호로 변환합니다.
